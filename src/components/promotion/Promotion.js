      ...
      <div className=" mt-5 pt-5 container">
        <div className="d-flex flex-column align-items-center invite-div ">
          ...
          <div className="ref-link d-flex flex-column align-items-center">
            <div className="bg-transparent d-flex w-100">
             {promotion !== null ? ( <p className="opacity-50 pe-4 ref-link-1">
                {hostName+promotion.activities.referral.url}
              </p>): ( <p className="opacity-50 pe-4">
                {hostName}
              </p>)}
             
              <i
                onClick={() => handleCopy(hostName+promotion.activities.referral.url)}
                id=""
        ...
        <div className="mt-4 commission-div rounded-4 p-3">
          <div className="bg-transparent d-flex">
            ...
            <button className="btn btn-light rounded-5 commission-btn ms-auto pe-1" onClick={handleInvite}>
              {" "}
              INVITE REWARDS   <i
                id=""
          ...
          <div className="bg-transparent amt-div mt-3 ">
            {promotion !== null ? (promotion.activities.referral.earning_today.daily.amount ? ( <p className="bg-transparent text-warning">{promotion.activities.referral.earning_today.daily.amount }</p>) : ( <p className="bg-transparent text-warning">0.0 USD</p>)): ""}
          ...
          <div className="bg-transparent d-flex w-100 pb-4 av-border ">
            <div className="bg-transparent d-flex w-75  ">
              <div className="bg-transparent amt-div mt-wg me-auto">
                ...
                {promotion !== null ? (promotion.activities.referral.commissions.earnings ? ( <p className="bg-transparent ">{promotion.activities.referral.commissions.earnings} USD</p>) : (  <p className="bg-transparent ">0.0 USD</p>)): ""}

                <small className="bg-transparent">Available Bal.</small>
              </div>
              <div className="bg-transparent amt-div mt-wg">
              {promotion !== null ? (promotion.current_earning ? (<p className="bg-transparent txt-color fw-bold ">{promotion.current_earning} USD</p>) : ( <p className="bg-transparent txt-color fw-bold ">0.0 USD</p>)): ""}
          ...
          <div className="bg-transparent mt-3 d-flex justify-content-around amt-div">
            ...
            <div className="bg-transparent d-flex flex-column align-items-center">
              ...
              {promotion !== null ? (promotion.active || promotion.inactive ? ( <small className="bg-transparent">{promotion.active + promotion.inactive}</small>) : ( <small className="bg-transparent">0</small>)): ""}
           
            </div>
            <div className="bg-transparent d-flex flex-column align-items-center">
              <p className="bg-transparent txt-color1">Active</p>
              {promotion !== null ? (promotion.active ? ( <small className="bg-transparent">{promotion.active}</small>) : ( <small className="bg-transparent">0</small>)): ""}
             
            </div>
            <div className="bg-transparent d-flex flex-column align-items-center" onClick={handlePending}>
              <p className="bg-transparent txt-color1">Pending</p>
              {promotion !== null ? (promotion.inactive ? ( <small className="bg-transparent">{promotion.inactive}</small>) : ( <small className="bg-transparent">0</small>)): ""}
