...
const ScoreAnti = () => {
  ...
  const filteredData = data[0]&&filterIds.size>0?
    // console.log('NOW HAS filteredData'),
    // console.log({filterIds}),
    // console.log({data}),
  ...
  console.log({e,filterNewGames});

  return (
    <div className="score-div-main">
      <InfiniteScroll
        dataLength={filterNewGames.length}
        next={filterNewGames}
