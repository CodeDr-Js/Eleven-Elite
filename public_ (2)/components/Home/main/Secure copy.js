    ...
    <div>
        ...
        <div className="m-color rounded-4 p-3">
          <div className=" bg-transparent d-flex justify-content-between">
            ...
            {/* home div */}
            <div className=" bg-transparent  flex-column align-items-center ">
              <div
                className= {`rounded-circle mb-2 ${e}`}  
                style={{ width: "50px", height: "50px" }}
              >
                <img className=" bg-transparent" src={hflag} style={{ width: "50px", height: "50px" }} />
              </div>
              <p className=" bg-transparent"> {home}</p>
            </div>

            {/* timer div */}
            <div style={{"textAlign":"center"} } className=" bg-transparent  align-items-center mt-1">
            ...
            {/* away div */}
            <div className="bg-transparent flex-column align-items-right row">
              <div
                className={`rounded-circle mb-2 ${s} secured-img-away`}
                style={{ width: "50px", height: "50px",float:'right' }}
              >
                <img className=" bg-transparent" src={aflag} style={{ width: "50px", height: "50px" }} />
              </div>
              <div className=" bg-transparent">
                <p style={{"textAlign":"right"} } className="  bg-transparent"> {away}</p>
              </div>
            </div>
        ...
        <div className=" bg-transparent"  style={{"display": "flex", "justify-content": "space-between"}}>
          <div className='row bg-transparent'>
              <div className='bg-transparent'><img className=" bg-transparent" src={hflag} style={{ width: "50px", height: "50px",float:'left' }} /></div>
              <p className=" bg-transparent"> {home}</p>  
          </div>
          ...
          <div className='row bg-transparent'>
            <div className='bg-transparent'><img className=" bg-transparent" src={aflag} style={{ width: "50px", height: "50px", }} /></div>
            <div className='bg-transparent'><p style={{"textAlign":"right"} } className="  bg-transparent"> {away}</p></div>
          </div>
        </div>
